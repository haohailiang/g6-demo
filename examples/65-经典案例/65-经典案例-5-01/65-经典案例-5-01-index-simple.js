...
graph.on('canvas:click', evt => {
    console.log('%c evt===', 'color:#fff;background: red;font-size:18px;', evt)
    const { clientX, clientY, x: modelX, y: modelY,  } = evt
    console.log('%c modelX===', 'color:#fffbackground: red', modelX)
    console.log('%c modelY===', 'color:#fffbackground: red', modelY)
})
